...
import * as API_PERSONS from "../api/person-api";
...
class DeletePersonForm extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            formControls: {
                id: {
                    value: '',
                    placeholder: 'What user do you want to delete? Introduce Id...',
                    valid: false,
                    touched: false,
                    validationRules: {
                        minLength: 3,
    ...
    deletePerson(person) {
        return API_PERSONS.deleteUserById(person, (result, status, error) => {
